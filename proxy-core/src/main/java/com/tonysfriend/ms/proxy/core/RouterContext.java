...
import com.tonysfriend.ms.proxy.core.config.ActionWrapper;
import com.tonysfriend.ms.proxy.core.invocation.ActionInvocation;
import com.tonysfriend.ms.proxy.core.invocation.ActionProxy;
import com.tonysfriend.ms.proxy.core.utils.PackageUtil;
import com.tonysfriend.ms.proxy.core.config.RouterConfig;
import com.tonysfriend.ms.proxy.core.exception.DuplicateActionException;
...
public class RouterContext {
	...
	private String findNamespace(Class<?> actionClass, Method method, RouterConfig config){
		...
		if(nsAnnotation != null){
			...
			String retNs = null;
			for(com.tonysfriend.ms.proxy.core.config.Namespace ns : config.getNamespaces()){
